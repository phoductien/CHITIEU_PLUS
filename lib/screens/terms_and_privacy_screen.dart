...
class TermsAndPrivacyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bodyColor = themeProvider.foregroundColor.withOpacity(0.8);
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              'Cập nhật lần cuối: 1 tháng 4, 2026. Bằng cách tiếp tục sử dụng ứng dụng, bạn đồng ý với các nội dung trên.',
              style: TextStyle(
                color: bodyColor,
                fontSize: 12,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            '1. TÀI KHOẢN CỦA BẠN',
            '1) Độ tuổi: Để tạo tài khoản, bạn phải đáp ứng độ tuổi tối thiểu theo quy định. Nếu bạn dưới độ tuổi quy định, phụ huynh hoặc người giám hộ hợp pháp của bạn đồng ý với các điều Khoản này.\n2) Tạo tài khoản: Bạn có quyền sử dụng email hoặc thông tin bên thứ ba để đăng ký. Bạn chịu trách nhiệm hoàn toàn đối với việc bảo mật thông tin đăng nhập.',
            primaryColor,
            bodyColor,
          ),
          _buildSection(
            '2. QUYỀN SỞ HỮU TRÍ TUỆ',
            'Toàn bộ mã nguồn, thiết kế UI/UX, đồ họa và thuật toán AI phân tích chi tiêu đều thuộc bản quyền bảo hộ của đội ngũ phát triển. Nghiêm cấm mọi hành vi sao chép, làm giả, hoặc phát tán trái phép.',
            primaryColor,
            bodyColor,
          ),
          _buildSection(
            '3. NGUYÊN TẮC HÀNH VI NGƯỜI DÙNG',
            'Bạn bị nghiêm cấm tham gia trực tiếp hoặc gián tiếp vào các hoạt động sau:\na) Lưu trữ ghi chú giao dịch mang tính vi phạm pháp luật hoặc bạo lực.\nb) Khai thác lỗi, lỗ hổng hệ thống để làm sai lệch biểu đồ báo cáo tài chính.\nc) Cố gắng vượt qua, vô hiệu hóa các biện pháp bảo mật trên Database.\nd) Gửi thư rác (spam) gây tắc nghẽn hệ thống phản hồi của chúng tôi.',
            primaryColor,
            bodyColor,
          ),
          _buildSection(
            '4. GIỚI HẠN TRÁCH NHIỆM',
            'Trong trường hợp phát hiện vi phạm Mục 3, chúng tôi có toàn quyền để:\n- Sửa đổi hoặc tạm ngưng các dịch vụ (như tính năng AI).\n- Chấm dứt và xóa vĩnh viễn tài khoản ChiTieuPlus của bạn trên hệ thống Cloud.',
            primaryColor,
            bodyColor,
          ),
          _buildSection(
            '5. TỪ CHỐI BẢO ĐẢM',
            'Do tính chất của thuật toán, Trợ lý AI và các biểu đồ phân tích ngân sách chỉ mang tính chất dự báo và tham khảo. Chúng tôi không chịu trách nhiệm bồi thường cho các quyết định đầu tư, tài chính sai lầm của bạn.',
            primaryColor,
            bodyColor,
          ),
          const SizedBox(height: 8),
          Container(
            ...
            child: Text(
              'Cập nhật lần cuối: 1 tháng 4, 2026. Nếu có bất kỳ câu hỏi nào, vui lòng liên hệ bộ phận hỗ trợ thông qua email.',
              style: TextStyle(
                color: bodyColor,
                fontSize: 12,
                fontStyle: FontStyle.italic,
