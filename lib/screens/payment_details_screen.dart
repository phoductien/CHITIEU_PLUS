...
class _PaymentDetailsScreenState extends State<PaymentDetailsScreen> {
  ...
  Future<void> _handleConfirm() async {
    ...
    try {
      final walletName = _selectedSource ?? languageProvider.translate('wallet_demo');
      ...
      if (mounted) {
        ...
        context.read<NotificationProvider>().addNotification(
          ...
          body: 'Bạn đã nạp thành công ${_formatCurrency(widget.amount)} vào $walletName',
        ...
        child: Column(
          ...
          children: [
            ...
            FadeInUp(
              ...
              child: _buildSourceSelection(themeProvider, languageProvider, bankAccounts),
            ),
          ],
        ),
      ),
  ...
  Widget _buildTransactionCard(ThemeProvider themeProvider, LanguageProvider languageProvider) {
    return Container(
      padding: const EdgeInsets.all(20),
      ...
      child: Column(
        children: [
          _buildDetailRow('Dịch vụ', 'Nạp tiền vào Ví ChiTieuPlus', themeProvider),
          ...
          const Divider(height: 30, color: Colors.white10),
          _buildDetailRow('Phí giao dịch', 'Miễn phí', themeProvider, valueColor: Colors.green),
  ...
  Widget _buildSourceSelection(ThemeProvider themeProvider, LanguageProvider languageProvider, List<String> bankAccounts) {
    return Column(
      children: [
        _buildSourceItem(
          title: 'Ví dùng thử',
        ...
        ...bankAccounts.map((account) => _buildSourceItem(
          title: account,
        ...
        child: Row(
          children: [
            ...
            if (isSelected)
              ...
              Icon(Icons.circle_outlined, color: themeProvider.foregroundColor.withValues(alpha: 0.2)),
          ],
        ),
      ),
    );
